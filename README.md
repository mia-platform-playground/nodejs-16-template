...
This is the best template to start creating a service in Node.js 16 integrated inside the platform
...
```json
{"name":"nodejs-16-template","status":"OK","version":"0.1.0"}
```
...
```shell
docker pull nexus.mia-platform.eu/github-app-test/nodejs-16-template:latest
set -a
source .env
docker run --name nodejs-16-template \
  ...
  -p 3000:3000 \
  --detach \
  nexus.mia-platform.eu/github-app-test/nodejs-16-template
```

[nvm]: https://github.com/creationix/nvm
[merge-request]: https://github.com/mia-platform-playground/nodejs-16-template/merge_requests
